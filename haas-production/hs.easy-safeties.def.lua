...
--- @field positionCount number | nil Number of position allowed before the check is preformed.

--- Deactivates the bot after an enter order has been completed.
--- @param positionCount number Optional - Number of position allowed before the check is preformed. Suggestions: Input
...
--- @param minutes number Number of positions allowed before the bot is deactivated. Suggestions: Input
--- @return boolean Returns true when the bot has been deactivated. Output Suggestions: Or, And, IsTrue, IsFalse, Not, BoolToSignal, IfElse, Switch, IfElseIf, SafetyContainer
...
--- @field count number | nil Number of orders allowed before the bot is deactivated.

--- Deactivates the bot after a number of orders has been completed.
--- @param count number Optional - Number of orders allowed before the bot is deactivated. Suggestions: Input
--- @return boolean Returns true when the bot has been deactivated. Output Suggestions: Or, And, IsTrue, IsFalse, Not, BoolToSignal, IfElse, Switch, IfElseIf, SafetyContainer
--- @overload fun(): boolean
...
--- @field count number | nil Number of positions allowed before the bot is deactivated.

--- Deactivates the bot after a number of positions has been completed.
--- @param count number Optional - Number of positions allowed before the bot is deactivated. Suggestions: Input
--- @return boolean Returns true when the bot has been deactivated. Output Suggestions: Or, And, IsTrue, IsFalse, Not, BoolToSignal, IfElse, Switch, IfElseIf, SafetyContainer
--- @overload fun(): boolean
...
--- @param maxLoss number Maximum allowed loss based on the ROI. Suggestions: Input
--- @return boolean Returns true when the bot has been deactivated. Output Suggestions: Or, And, IsTrue, IsFalse, Not, BoolToSignal, IfElse, Switch, IfElseIf, SafetyContainer
...
--- @param minProfit number Minimum profit based on the ROI. Suggestions: Input
--- @return boolean Returns true when the bot has been deactivated. Output Suggestions: Or, And, IsTrue, IsFalse, Not, BoolToSignal, IfElse, Switch, IfElseIf, SafetyContainer
...
--- @field depth number | nil Read depth. Default is 30 ticks.
...
--- @param percentage number Price pump percentage. Suggestions: Input
--- @param depth number Optional - Read depth. Default is 30 ticks. Suggestions: Input
...
--- @overload fun(percentage: number): boolean
--- @overload fun(percentage: number, depth: number): boolean
--- @overload fun(percentage: number, depth: number, positionId: string): boolean
--- @overload fun(percentage: number, optionalParameters: OptionalParametersOf_DynamicStopLoss): boolean
...
--- @overload fun(percentage: number, depth: number): boolean
--- @overload fun(percentage: number, depth: number, positionId: string): boolean
--- @overload fun(percentage: number, optionalParameters: OptionalParametersOf_DynamicTakeProfit): boolean
...
--- @param percentage number Trailing stop loss percentage. Suggestions: Input
--- @param growPercentage number The grow percentage. 0.035 for example. Suggestions: Input
--- @param positionId string Optional - Optional unique identifier. Required when the bot is trading multiple position at once. Suggestions: Load
--- @param direction Enum Optional - The direction of the position. PositionLong or PositionShort. By default both. Suggestions: PositionBought, PositionLong, PositionShort, PositionSold, NoPosition
...
--- @overload fun(percentage: number, growPercentage: number): boolean
--- @overload fun(percentage: number, growPercentage: number, positionId: string): boolean
--- @overload fun(percentage: number, growPercentage: number, optionalParameters: OptionalParametersOf_GrowingTrailingStopLoss): boolean
...
--- @param percentage number Trailing stop loss percentage. Suggestions: Input
--- @param shrinkPercentage number This percentage will be added to the stop every time the stop adjust. The percentage will raise exponentially on every adjustment. Suggestions: Input
--- @param positionId string Optional - Optional unique identifier. Required when the bot is trading multiple position at once. Suggestions: Load
--- @param direction Enum Optional - The direction of the position. PositionLong or PositionShort. By default both. Suggestions: PositionBought, PositionLong, PositionShort, PositionSold, NoPosition
--- @return boolean Returns true if the stop loss has been hit. Output Suggestions: Or, And, IsTrue, IsFalse, Not, BoolToSignal, IfElse, Switch, IfElseIf, SafetyContainer
--- @overload fun(percentage: number, shrinkPercentage: number): boolean
--- @overload fun(percentage: number, shrinkPercentage: number, positionId: string): boolean
--- @overload fun(percentage: number, shrinkPercentage: number, optionalParameters: OptionalParametersOf_ShrinkingTrailingStopLoss): boolean
...
--- @param percentage number Stop loss percentage. Suggestions: Input
--- @param positionId string Optional - Optional unique identifier. Required when the bot is trading multiple position at once. Suggestions: Load
--- @param direction Enum Optional - The direction of the position. PositionLong or PositionShort. By default both. Suggestions: PositionBought, PositionLong, PositionShort, PositionSold, NoPosition
--- @return boolean Returns true if the stop loss has been hit. Output Suggestions: Or, And, IsTrue, IsFalse, Not, BoolToSignal, IfElse, Switch, IfElseIf, SafetyContainer
--- @overload fun(percentage: number): boolean
--- @overload fun(percentage: number, positionId: string): boolean
--- @overload fun(percentage: number, optionalParameters: OptionalParametersOf_StopLoss): boolean
...
--- @param percentage number Stop loss ROI percentage. Suggestions: Input
--- @param positionId string Optional - Optional unique identifier. Required when the bot is trading multiple position at once. Suggestions: Load
--- @param direction Enum Optional - The direction of the position. PositionLong or PositionShort. By default both. Suggestions: PositionBought, PositionLong, PositionShort, PositionSold, NoPosition
--- @return boolean Returns true if the stop loss has been hit. Output Suggestions: Or, And, IsTrue, IsFalse, Not, BoolToSignal, IfElse, Switch, IfElseIf, SafetyContainer
--- @overload fun(percentage: number): boolean
--- @overload fun(percentage: number, positionId: string): boolean
--- @overload fun(percentage: number, optionalParameters: OptionalParametersOf_StopLossROI): boolean
...
--- @param percentage number Take profit percentage. Suggestions: Input
--- @param positionId string Optional - Optional unique identifier. Required when the bot is trading multiple position at once. Suggestions: Load
--- @param direction Enum Optional - The direction of the position. PositionLong or PositionShort. By default both. Suggestions: PositionBought, PositionLong, PositionShort, PositionSold, NoPosition
...
--- @overload fun(percentage: number): boolean
--- @overload fun(percentage: number, positionId: string): boolean
--- @overload fun(percentage: number, optionalParameters: OptionalParametersOf_TakeProfit): boolean
...
--- @param percentage number Take profit ROI percentage. Suggestions: Input
--- @param positionId string Optional - Optional unique identifier. Required when the bot is trading multiple position at once. Suggestions: Load
--- @param direction Enum Optional - The direction of the position. PositionLong or PositionShort. By default both. Suggestions: PositionBought, PositionLong, PositionShort, PositionSold, NoPosition
--- @return boolean Returns true if the take profit has been reached. Output Suggestions: Or, And, IsTrue, IsFalse, Not, BoolToSignal, IfElse, Switch, IfElseIf, SafetyContainer
--- @overload fun(percentage: number): boolean
--- @overload fun(percentage: number, positionId: string): boolean
--- @overload fun(percentage: number, optionalParameters: OptionalParametersOf_TakeProfitROI): boolean
...
--- @param percentage number Trailing stop loss percentage. Suggestions: Input
--- @param arm number The Arm percentage. Suggestions: Input
--- @param positionId string Optional - Optional unique identifier. Required when the bot is trading multiple position at once. Suggestions: Load
--- @param direction Enum Optional - The direction of the position. PositionLong or PositionShort. By default both. Suggestions: PositionBought, PositionLong, PositionShort, PositionSold, NoPosition
--- @return boolean Returns true if the stop loss has been hit. Output Suggestions: Or, And, IsTrue, IsFalse, Not, BoolToSignal, IfElse, Switch, IfElseIf, SafetyContainer
--- @overload fun(percentage: number, arm: number): boolean
--- @overload fun(percentage: number, arm: number, positionId: string): boolean
--- @overload fun(percentage: number, arm: number, optionalParameters: OptionalParametersOf_TrailingArmStopLoss): boolean
...
--- @overload fun(percentage: number): boolean
--- @overload fun(percentage: number, positionId: string): boolean
--- @overload fun(percentage: number, optionalParameters: OptionalParametersOf_TrailingStopLoss): boolean
