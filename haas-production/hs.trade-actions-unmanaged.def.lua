...
--- @overload fun(price: number, amount: number, market: string, type: Enum, note: string, positionId: string, timeout: number, triggerPrice: number): string
--- @overload fun(price: number, amount: number, market: string, type: Enum, note: string, positionId: string, timeout: number, triggerPrice: number, reduceOnly: boolean): string
...
--- @param price number Optional - The price on which to execute. Be defaults the best ask or bid price is used. Suggestions: AskPrices, BuyPrices, BidPrices, SellPrices, OpenPrices, HighPrices, LowPrices, ClosePrices, Prices, HLPrices, HLCPrices, OCPrices, HeikenClosePrices, OHLCPrices, GetBodyHighPrices, GetBodyLowPrices
