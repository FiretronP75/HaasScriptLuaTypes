...
--- @param value1 number | table Source value(s) 1.
--- @param value2 number | table Source value(s) 2.
...
--- @param value1 number | table Source value(s) 1.
--- @param value2 number | table Source value(s) 2.
--- @return number Returns the number of ticks since the last crossover. Return value of 1 represents the crossunder happening 'now'. Output Suggestions: Equals, IsBiggerOrSmallerThan, IsSmallerThan, IsBiggerThan, Compare, Add, Sum, Sub, Mul, Mult, Div, AddPerc, AddPercentage, SubPerc, SubPercentage, Plot
...
--- @param value1 number | table Source value(s) 1.
--- @param value2 number | table Source value(s) 2.
--- @return number Returns the number of ticks since the last crossunder. Return value of 1 represents the crossunder happening 'now'. Output Suggestions: Equals, IsBiggerOrSmallerThan, IsSmallerThan, IsBiggerThan, Compare, Add, Sum, Sub, Mul, Mult, Div, AddPerc, AddPercentage, SubPerc, SubPercentage, Plot
...
--- @param input2 number | table Source value(s) 2.
...
--- @param lookback number Lookback value. Suggestions: Input
...
--- @param array number[] Source values.
--- @param lookback number Lookback value. Suggestions: Input
--- @return number Returns the number of ticks the data is falling. Output Suggestions: Equals, IsBiggerOrSmallerThan, IsSmallerThan, IsBiggerThan, Compare, Add, Sum, Sub, Mul, Mult, Div, AddPerc, AddPercentage, SubPerc, SubPercentage, Plot
...
--- @param array number[] Source values.
--- @param lookback number Lookback value. Suggestions: Input
--- @return number Returns the number of ticks the data is rising. Output Suggestions: Equals, IsBiggerOrSmallerThan, IsSmallerThan, IsBiggerThan, Compare, Add, Sum, Sub, Mul, Mult, Div, AddPerc, AddPercentage, SubPerc, SubPercentage, Plot
