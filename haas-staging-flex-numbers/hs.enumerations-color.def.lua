...
--- @field opacity number | number[] | nil The color opacity, 0-100. By default 100.
...
--- @field a number | number[] | nil The alpha component value for the new color. Valid values are 0 through 255.

--- Creates an RGBA color string.
--- @param r number | number[] The red component value for the new color. Valid values are 0 through 255. Suggestions: Input
--- @param g number | number[] The green component value for the new color. Valid values are 0 through 255. Suggestions: Input
--- @param b number | number[] The blue component value for the new color. Valid values are 0 through 255. Suggestions: Input
--- @param a number | number[] Optional - The alpha component value for the new color. Valid values are 0 through 255. Suggestions: Input
...
--- @overload fun(r: number | number[], g: number | number[], b: number | number[]): string
--- @overload fun(r: number | number[], g: number | number[], b: number | number[], optionalParameters: OptionalParametersOf_Color): string
