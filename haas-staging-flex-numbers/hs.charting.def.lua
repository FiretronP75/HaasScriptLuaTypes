...
--- @param opacity number | number[] Opacity level from 0 - 100.
...
--- @param value number | number[] The y-axis value on which to place the label. Suggestions: Input
...
--- @return void
--- @overload fun(chartId: number | number[], side: Enum, text: string, value: number | number[]): void
--- @overload fun(chartId: number | number[], side: Enum, text: string, value: number | number[], color: string | ColorEnum): void
--- @overload fun(chartId: number | number[], side: Enum, text: string, value: number | number[], optionalParameters: OptionalParametersOf_ChartAddAxisLabel): void
...
--- @field low number | number[] | nil Low prices array.
--- @field high number | number[] | nil High prices array.
...
--- @param chartId number | number[] The chart index on which to apply the settings.
--- @param side Enum The side of the chart on which to apply the settings. Suggestions: RightAxis, LeftAxis
--- @param low number | number[] Optional - Low prices array.
--- @param high number | number[] Optional - High prices array.
...
--- @return void
--- @overload fun(chartId: number | number[], side: Enum): void
--- @overload fun(chartId: number | number[], side: Enum, low: number | number[]): void
--- @overload fun(chartId: number | number[], side: Enum, low: number | number[], high: number | number[]): void
--- @overload fun(chartId: number | number[], side: Enum, low: number | number[], high: number | number[], visible: boolean): void
--- @overload fun(chartId: number | number[], side: Enum, optionalParameters: OptionalParametersOf_ChartSetAxisOptions): void
...
--- @field height number | number[] | nil Chart height. Below 1 will be treated as percentage (0.5-50%).
--- @field style Enum | nil Price plot style.

--- Gives control over chart options such as title and height.
--- @param chartId number | number[] The chart index on which to apply the options.
--- @param title string Optional - Chart title.
--- @param height number | number[] Optional - Chart height. Below 1 will be treated as percentage (0.5-50%).
...
--- @return void
--- @overload fun(chartId: number | number[]): void
--- @overload fun(chartId: number | number[], title: string): void
--- @overload fun(chartId: number | number[], title: string, height: number | number[]): void
--- @overload fun(chartId: number | number[], optionalParameters: OptionalParametersOf_ChartSetOptions): void
...
--- @param width number | number[] Optional - The width of the line.
--- @param offset number | number[] Optional - A positive offset will move the data points x number of candles. A negative number will move the data points back. Suggestions: Input
...
--- @overload fun(color: string | ColorEnum, style: Enum, deco: Enum, width: number | number[]): any
--- @overload fun(color: string | ColorEnum, style: Enum, deco: Enum, width: number | number[], offset: number | number[]): any
--- @overload fun(color: string | ColorEnum, style: Enum, deco: Enum, width: number | number[], offset: number | number[], side: Enum): any
--- @overload fun(color: string | ColorEnum, style: Enum, deco: Enum, width: number | number[], offset: number | number[], side: Enum, id: string): any
--- @overload fun(color: string | ColorEnum, style: Enum, deco: Enum, width: number | number[], offset: number | number[], side: Enum, id: string, behind: boolean): any
--- @overload fun(color: string | ColorEnum, style: Enum, deco: Enum, width: number | number[], offset: number | number[], side: Enum, id: string, behind: boolean, ignoreOnAxis: boolean): any
...
--- @field depth number | number[] | nil Amount of candles to mark.

--- Changes the color of a single candle.
--- @param chartId number | number[] The chart index on which to mark the candle.
--- @param depth number | number[] Optional - Amount of candles to mark.
--- @return void
--- @overload fun(chartId: number | number[]): void
--- @overload fun(chartId: number | number[], optionalParameters: OptionalParametersOf_MarkCandle): void
...
--- @param value number | number[] | table Value of the data point.
...
--- @overload fun(chartId: number | number[], lineName: string, value: number | number[] | table): string
--- @overload fun(chartId: number | number[], lineName: string, value: number | number[] | table, optionalParameters: OptionalParametersOf_Plot): string
...
--- @param baseValue number | number[] Optional - The value from where the bars are drawn. Default is 0.
...
--- @overload fun(lineGuid: string, baseValue: number | number[]): void
...
--- @field lower number | number[] | table | nil Lower band data. Optional, if not set only a band is plotted.

--- Takes care of the plotting side of a BBANDS (like) calculation and chart.
--- @param chartIndex number | number[] Chart index on which to plot. Suggestions: Input
--- @param name string Name of the line. Suggestions: Input, Load
--- @param upper number | number[] | table Upper band data. Suggestions: ABANDS, BBANDS, DONCHIAN, KELTNER
--- @param middle number | number[] | table Middle or lower band data. Suggestions: ABANDS, BBANDS, DONCHIAN, KELTNER
--- @param lower number | number[] | table Optional - Lower band data. Optional, if not set only a band is plotted. Suggestions: ABANDS, BBANDS, DONCHIAN, KELTNER
--- @return void
--- @overload fun(chartIndex: number | number[], name: string, upper: number | number[] | table, middle: number | number[] | table): void
--- @overload fun(chartIndex: number | number[], name: string, upper: number | number[] | table, middle: number | number[] | table, optionalParameters: OptionalParametersOf_PlotBBandsChart): void
...
--- @param chartId number | number[] The chart index on which to plot the data.
--- @param start number | number[] The lowest value of the zone. Suggestions: Input
--- @param endValue number | number[] The highest value of the zone. Suggestions: Input
--- @return void
...
--- @param opacity number | number[] The opacity of the inner cloud color.
--- @return void
...
--- @param lineGuid string Line guid returned by Plot(). Suggestions: Plot
--- @param baseValue number | number[] The value where the line changes color.
...
--- @return void
--- @overload fun(lineGuid: string, baseValue: number | number[], secondColor: string | ColorEnum): void
--- @overload fun(lineGuid: string, baseValue: number | number[], secondColor: string | ColorEnum, optionalParameters: OptionalParametersOf_PlotDoubleColor): void
...
--- @field shortSignal number | number[] | table | nil Optional, short data line.
--- @field longSignal number | number[] | table | nil Optional, long data line.

--- Takes care of the plotting side of a MACD (like) calculation and chart.
--- @param chartIndex number | number[] Chart index on which to plot. Suggestions: Input
--- @param name string Name of the line. Suggestions: Input, Load
--- @param histogram number | number[] | table Histogram data. Suggestions: MACD, MACDEXT, MACDFIX
--- @param shortSignal number | number[] | table Optional - Optional, short data line. Suggestions: MACD, MACDEXT, MACDFIX
--- @param longSignal number | number[] | table Optional - Optional, long data line. Suggestions: MACD, MACDEXT, MACDFIX
--- @return void
--- @overload fun(chartIndex: number | number[], name: string, histogram: number | number[] | table): void
--- @overload fun(chartIndex: number | number[], name: string, histogram: number | number[] | table, shortSignal: number | number[] | table): void
--- @overload fun(chartIndex: number | number[], name: string, histogram: number | number[] | table, optionalParameters: OptionalParametersOf_PlotHistogramSignals): void
...
--- @param value number | number[] The y-axis value on which to place the line. Suggestions: Input
...
--- @return void
--- @overload fun(chartId: number | number[], name: string, color: string | ColorEnum, value: number | number[]): void
--- @overload fun(chartId: number | number[], name: string, color: string | ColorEnum, value: number | number[], lineDecoration: Enum): void
--- @overload fun(chartId: number | number[], name: string, color: string | ColorEnum, value: number | number[], lineDecoration: Enum, side: Enum): void
--- @overload fun(chartId: number | number[], name: string, color: string | ColorEnum, value: number | number[], optionalParameters: OptionalParametersOf_PlotHorizontalLine): void
...
--- @param side Enum Optional - Axis side on which to snap the line. Default is RightAxis. Suggestions: RightAxis, LeftAxis
--- @return void
--- @overload fun(chartId: number | number[], name: string, color: string | ColorEnum, start: number | number[], endValue: number | number[]): void
--- @overload fun(chartId: number | number[], name: string, color: string | ColorEnum, start: number | number[], endValue: number | number[], optionalParameters: OptionalParametersOf_PlotHorizontalZone): void
...
--- @param chartIndex number | number[] Chart index on which to plot. Suggestions: Input
--- @param name string Name of the line. Suggestions: Input, Load
--- @param source number | number[] | table Value to plot. Suggestions: RSI
--- @param start number | number[] The lowest value of the zone. Suggestions: Input
--- @param endValue number | number[] The highest value of the zone. Suggestions: Input
--- @return void
...
--- @param leftStrength number | number[] Amount of bars before the pivot point that must be lower(Pivot Low)/higher(Pivot High) than the pivot price. Suggestions: Input
--- @param rightStrength number | number[] Amount of bars after the pivot point that must be lower(Pivot Low)/higher(Pivot High) than the pivot price. Suggestions: Input
--- @return void
...
--- @param chartId number | number[] The chart index on which to plot the price data.
...
--- @param interval number | number[] Optional - The interval which to plot. Suggestions: InputInterval, CurrentInterval
...
--- @return void
--- @overload fun(chartId: number | number[], market: string): void
--- @overload fun(chartId: number | number[], market: string, interval: number | number[]): void
--- @overload fun(chartId: number | number[], market: string, interval: number | number[], style: Enum): void
--- @overload fun(chartId: number | number[], market: string, interval: number | number[], style: Enum, upColor: string | ColorEnum): void
--- @overload fun(chartId: number | number[], market: string, interval: number | number[], style: Enum, upColor: string | ColorEnum, upFill: boolean): void
--- @overload fun(chartId: number | number[], market: string, interval: number | number[], style: Enum, upColor: string | ColorEnum, upFill: boolean, downColor: string | ColorEnum): void
--- @overload fun(chartId: number | number[], market: string, interval: number | number[], style: Enum, upColor: string | ColorEnum, upFill: boolean, downColor: string | ColorEnum, downFill: boolean): void
--- @overload fun(chartId: number | number[], market: string, interval: number | number[], style: Enum, upColor: string | ColorEnum, upFill: boolean, downColor: string | ColorEnum, downFill: boolean, markColor: string | ColorEnum): void
--- @overload fun(chartId: number | number[], market: string, optionalParameters: OptionalParametersOf_PlotPrice): void
...
--- @param chartId number | number[] Optional - Index on which to plot the line.
...
--- @param size number | number[] Optional - Size of the shape.
...
--- @overload fun(): void
--- @overload fun(chartId: number | number[]): void
--- @overload fun(chartId: number | number[], shape: Enum): void
--- @overload fun(chartId: number | number[], shape: Enum, color: string | ColorEnum): void
--- @overload fun(chartId: number | number[], shape: Enum, color: string | ColorEnum, size: number | number[]): void
--- @overload fun(chartId: number | number[], shape: Enum, color: string | ColorEnum, size: number | number[], aboveCandle: boolean): void
--- @overload fun(chartId: number | number[], shape: Enum, color: string | ColorEnum, size: number | number[], aboveCandle: boolean, text: string): void
--- @overload fun(chartId: number | number[], shape: Enum, color: string | ColorEnum, size: number | number[], aboveCandle: boolean, text: string, textColor: string | ColorEnum): void
...
--- @param name string Name of the line. This needs to be unique per index.
--- @param color string | ColorEnum The line color. Suggestions: Aqua, Black, Blue, Cyan, DarkGray, DarkGreen, Fuchsia, Gold, Gray, Green, Maroon, Olive, Orange, Purple, Red, SkyBlue, Teal, White, Yellow, ChangeColorOpacity
--- @param unix number | number[] The x-axis timestamp on which to place the line. Suggestions: Input
--- @param lineDecoration Enum Optional - Line decoration style. Default is Solid. Suggestions: Solid, Dashed, Dotted
--- @return void
--- @overload fun(chartId: number | number[], name: string, color: string | ColorEnum, unix: number | number[]): void
--- @overload fun(chartId: number | number[], name: string, color: string | ColorEnum, unix: number | number[], optionalParameters: OptionalParametersOf_PlotVerticalLine): void
...
--- @param name string Name of the zone. This needs to be unique per index.
--- @param color string | ColorEnum The zone inner color. Suggestions: Aqua, Black, Blue, Cyan, DarkGray, DarkGreen, Fuchsia, Gold, Gray, Green, Maroon, Olive, Orange, Purple, Red, SkyBlue, Teal, White, Yellow, ChangeColorOpacity
--- @param start number | number[] The lowest value of the zone on the y-axis. Suggestions: Input
--- @param endValue number | number[] The highest value of the zone on the y-axis. Suggestions: Input
--- @return void
...
--- @return void
--- @overload fun(chartId: number | number[]): void
--- @overload fun(chartId: number | number[], upColor: string | ColorEnum): void
--- @overload fun(chartId: number | number[], upColor: string | ColorEnum, downColor: string | ColorEnum): void
--- @overload fun(chartId: number | number[], upColor: string | ColorEnum, downColor: string | ColorEnum, upFill: boolean): void
--- @overload fun(chartId: number | number[], upColor: string | ColorEnum, downColor: string | ColorEnum, upFill: boolean, downFill: boolean): void
--- @overload fun(chartId: number | number[], optionalParameters: OptionalParametersOf_PlotVolume): void
