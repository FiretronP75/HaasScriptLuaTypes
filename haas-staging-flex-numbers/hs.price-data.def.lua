...
--- @overload fun(): number[]
--- @overload fun(interval: number | number[]): number[]
--- @overload fun(interval: number | number[], fullCandles: boolean): number[]
--- @overload fun(interval: number | number[], fullCandles: boolean, market: string): number[]
...
--- @field open number | number[] The open price of the current candle.
--- @field high number | number[] The high price of the current candle.
--- @field low number | number[] The low price of the current candle.
--- @field close number | number[] The close price of the current candle.
--- @field volume number | number[] The volume of the current candle.
--- @field ask number | number[] The ask/buy price of the current candle.
--- @field bid number | number[] The bid/sell price of the current candle.
--- @field [1] number | number[] The open price of the current candle.
--- @field [2] number | number[] The high price of the current candle.
--- @field [3] number | number[] The low price of the current candle.
--- @field [4] number | number[] The close price of the current candle.
--- @field [5] number | number[] The volume of the current candle.
--- @field [6] number | number[] The ask/buy price of the current candle.
--- @field [7] number | number[] The bid/sell price of the current candle.
...
--- @overload fun(sourceType: Enum, interval: number | number[]): number[]
--- @overload fun(sourceType: Enum, interval: number | number[], fullCandles: boolean): number[]
--- @overload fun(sourceType: Enum, interval: number | number[], fullCandles: boolean, market: string): number[]
