...
--- @param price number | number[] The close price of the position. Suggestions: UserPositionContainer
--- @param amount number | number[] The amount to adjust: negative value reduces, positive value adds. Suggestions: UserPositionContainer
--- @param positionId string Optional - Unique position identifier. Suggestions: NewGuid, Load
--- @return void
--- @overload fun(price: number | number[], amount: number | number[]): void
--- @overload fun(price: number | number[], amount: number | number[], optionalParameters: OptionalParametersOf_AdjustVPosition): void
...
--- @param price number | number[] The enter price of the position. Suggestions: UserPositionContainer
--- @param positionId string Optional - Unique position identifier. Suggestions: NewGuid, Load
--- @return void
--- @overload fun(price: number | number[]): void
--- @overload fun(price: number | number[], optionalParameters: OptionalParametersOf_CloseVPosition): void
...
--- @field leverage number | number[] | nil The leverage of the position. -1 for default.
--- @field positionId string | nil Unique position identifier.
...
--- @param price number | number[] The enter price of the position. Suggestions: UserPositionContainer
--- @param amount number | number[] The size of the position. Suggestions: UserPositionContainer, MaxExitLongAmount, MaxExitShortAmount
...
--- @param leverage number | number[] Optional - The leverage of the position. -1 for default. Suggestions: Input, Leverage
--- @param positionId string Optional - Unique position identifier. Suggestions: NewGuid, Load
...
--- @overload fun(direction: Enum, price: number | number[], amount: number | number[]): string
--- @overload fun(direction: Enum, price: number | number[], amount: number | number[], market: string): string
--- @overload fun(direction: Enum, price: number | number[], amount: number | number[], market: string, leverage: number | number[]): string
--- @overload fun(direction: Enum, price: number | number[], amount: number | number[], optionalParameters: OptionalParametersOf_CreatePosition): string
...
--- @return number | number[] Returns the total amount open in a specific position. Output Suggestions: PlaceBuyOrder, PlaceSellOrder, PlaceGoLongOrder, PlaceGoShortOrder, PlaceExitLongOrder, PlaceExitShortOrder
--- @overload fun(): number | number[]
--- @overload fun(optionalParameters: OptionalParametersOf_GetPositionAmount): number | number[]
...
--- @overload fun(optionalParameters: OptionalParametersOf_GetPositionEnterPrice): number | number[]
...
--- @field positionId string | nil Optional unique identifier. Required when the bot is trading multiple position at once.
--- @field targetPrice number | number[] | nil Optional target price. Default is the best bid/ask.

--- Gets the total realized plus unrealized profit of a specific position.
--- @param positionId string Optional - Optional unique identifier. Required when the bot is trading multiple position at once. Suggestions: Load
--- @param targetPrice number | number[] Optional - Optional target price. Default is the best bid/ask. Suggestions: AskPrices, BuyPrices, BidPrices, SellPrices, OpenPrices, HighPrices, LowPrices, ClosePrices, Prices, HLPrices, HLCPrices, OCPrices, HeikenClosePrices, OHLCPrices, GetBodyHighPrices, GetBodyLowPrices
--- @return number | number[] Returns the total realized plus unrealized profit of a specific position. On spot/margin the result will be in the quote currency. For leverage its in the underlying currency. Output Suggestions: Equals, IsBiggerOrSmallerThan, IsSmallerThan, IsBiggerThan, Compare, Add, Sum, Sub, Mul, Mult, Div, AddPerc, AddPercentage, SubPerc, SubPercentage, Plot
--- @overload fun(): number | number[]
--- @overload fun(positionId: string): number | number[]
--- @overload fun(optionalParameters: OptionalParametersOf_GetPositionProfit): number | number[]
...
--- @param positionId string Optional - Optional unique identifier. Required when the bot is trading multiple position at once. Suggestions: Load
--- @param targetPrice number | number[] Optional - Optional target price. Default is the best bid/ask. Suggestions: AskPrices, BuyPrices, BidPrices, SellPrices, OpenPrices, HighPrices, LowPrices, ClosePrices, Prices, HLPrices, HLCPrices, OCPrices, HeikenClosePrices, OHLCPrices, GetBodyHighPrices, GetBodyLowPrices
--- @return number | number[] Returns the ROI as a percentage. Output Suggestions: Equals, IsBiggerOrSmallerThan, IsSmallerThan, IsBiggerThan, Compare, Add, Sum, Sub, Mul, Mult, Div, AddPerc, AddPercentage, SubPerc, SubPercentage, Plot
--- @overload fun(): number | number[]
--- @overload fun(positionId: string): number | number[]
--- @overload fun(optionalParameters: OptionalParametersOf_GetPositionROI): number | number[]
...
--- @return number | number[] Returns the total amount open in a long position. Output Suggestions: Equals, IsBiggerOrSmallerThan, IsSmallerThan, IsBiggerThan, Compare, Add, Sum, Sub, Mul, Mult, Div, AddPerc, AddPercentage, SubPerc, SubPercentage, Plot
--- @overload fun(): number | number[]
--- @overload fun(optionalParameters: OptionalParametersOf_LongAmount): number | number[]
...
--- @field enterPrice number | number[] The average enter price. Suggestions: AddPerc, AddPercentage, SubPerc, SubPercentage, IsBiggerThan, IsSmallerThan
--- @field amount number | number[] The amount open in the position. Suggestions: PlaceExitLongOrder, PlaceExitShortOrder, PlaceSellOrder, PlaceBuyOrder
--- @field profit number | number[] The realized + unrealized profits. Suggestions: IsBiggerThan, IsSmallerThan
--- @field roi number | number[] The ROI based on the used margin and realized + unrealized profits. Suggestions: IsBiggerThan, IsSmallerThan
--- @field openTime number | number[] Timestamp (in unix) when the position was opened. Suggestions: IsBiggerThan, IsSmallerThan
--- @field updatedTime number | number[] Timestamp (in unix) when the position was last updated. Suggestions: IsBiggerThan, IsSmallerThan
--- @field closeTime number | number[] Timestamp (in unix) when the position was closed. If position is still open, value will be 0. Suggestions: IsBiggerThan, IsSmallerThan
...
--- @field [5] number | number[] The average enter price. Suggestions: AddPerc, AddPercentage, SubPerc, SubPercentage, IsBiggerThan, IsSmallerThan
--- @field [6] number | number[] The amount open in the position. Suggestions: PlaceExitLongOrder, PlaceExitShortOrder, PlaceSellOrder, PlaceBuyOrder
--- @field [7] number | number[] The realized + unrealized profits. Suggestions: IsBiggerThan, IsSmallerThan
--- @field [8] number | number[] The ROI based on the used margin and realized + unrealized profits. Suggestions: IsBiggerThan, IsSmallerThan
--- @field [9] number | number[] Timestamp (in unix) when the position was opened. Suggestions: IsBiggerThan, IsSmallerThan
--- @field [10] number | number[] Timestamp (in unix) when the position was last updated. Suggestions: IsBiggerThan, IsSmallerThan
--- @field [11] number | number[] Timestamp (in unix) when the position was closed. If position is still open, value will be 0. Suggestions: IsBiggerThan, IsSmallerThan
...
--- @param market string Optional - The market returned by PriceMarket(), InputAccountMarket() or InputMarket() for example. Suggestions: InputAccountMarket, InputMarket, InputPriceSourceMarket, PriceMarket
--- @return number | number[] Returns the total amount open in a short position. Output Suggestions: Equals, IsBiggerOrSmallerThan, IsSmallerThan, IsBiggerThan, Compare, Add, Sum, Sub, Mul, Mult, Div, AddPerc, AddPercentage, SubPerc, SubPercentage, Plot
--- @overload fun(): number | number[]
--- @overload fun(optionalParameters: OptionalParametersOf_ShortAmount): number | number[]
