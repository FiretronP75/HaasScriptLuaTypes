...
--- @return Enum Indicator Result. Output Suggestions: Equals, DoSignal, PlotSignalEnum, ConvertSignal, MapSignal, IgnoreSignalIf, UseSignalIf, ReverseSignal, SignalWeight, SignalToBool, SignalMapper, SignalProperties, GetWeightedConsensusSignal, GetUnanimousSignal, GetConsensusSignal, IndicatorContainer, TradeBotContainer
--- @overload fun(chartIndex: number | number[]): Enum
--- @overload fun(chartIndex: number | number[], optionalParameters: OptionalParametersOf_CC_EasyHullMA): Enum
...
--- @param period number | number[] Period Length. Suggestions: Input, InputAccount, InputAccountMarket, InputButton, InputCdlTypes, InputConstant, InputGroupHeader, InputInterval, InputLrTypes, InputMarket, InputMaTypes, InputOptions, InputOrderType, InputPriceSource, InputPriceSourceMarket, InputSignalManagement, InputSignalTypes, InputSourcePrice, InputTable, InputTableColumn, InputTableOptions, AccountGuid, CurrentInterval, Fee, Leverage, PriceMarket, TradeAmount
--- @param maType Enum Optional - Type of Moving Average. Suggestions: InputMaTypes
--- @return number[] Hull Moving Average values array
--- @overload fun(source: number[], period: number | number[]): number[]
--- @overload fun(source: number[], period: number | number[], optionalParameters: OptionalParametersOf_CC_HMA): number[]
