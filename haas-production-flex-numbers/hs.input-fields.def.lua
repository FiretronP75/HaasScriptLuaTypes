...
--- @field defaultValue number | number[] | nil The default value for the field.
--- @field tooltip string | nil The tooltip text for the field.
--- @field group string | nil The group of the input field.

--- Creates an interval dropdown.
--- @param label string The field label text.
--- @param defaultValue number | number[] Optional - The default value for the field.
--- @param tooltip string Optional - The tooltip text for the field.
--- @param group string Optional - The group of the input field.
--- @return number | number[] Returns the selected interval in minutes. Output Suggestions: AskPrices, BuyPrices, BidPrices, SellPrices, OpenPrices, HighPrices, LowPrices, ClosePrices, Prices, GetVolume, GetBodyHighPrices, GetBodyLowPrices
--- @overload fun(label: string): number | number[]
--- @overload fun(label: string, defaultValue: number | number[]): number | number[]
--- @overload fun(label: string, defaultValue: number | number[], tooltip: string): number | number[]
--- @overload fun(label: string, optionalParameters: OptionalParametersOf_InputInterval): number | number[]
...
--- @field rows number | number[] | nil Fixed number of rows. Overwrites maxRows.
--- @field maxRows number | number[] | nil Dynamic number of rows with a maximum.
...
--- @param rows number | number[] Optional - Fixed number of rows. Overwrites maxRows.
--- @param maxRows number | number[] Optional - Dynamic number of rows with a maximum.
--- @param group string Optional - Group of the table.
--- @return any Returns the options objects.
--- @overload fun(): any
--- @overload fun(title: string): any
--- @overload fun(title: string, rows: number | number[]): any
--- @overload fun(title: string, rows: number | number[], maxRows: number | number[]): any
