...
--- @param value number | number[] | table The value to compare.
--- @param lowValue number | number[] The lowest value. Suggestions: Input
--- @param highValue number | number[] The highest value. Suggestions: Input
...
--- @param input1 number | number[] | table The value to compare.
--- @param input2 number | number[] The value to compare with. Suggestions: Input
