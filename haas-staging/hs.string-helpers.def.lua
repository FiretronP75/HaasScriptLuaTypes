...
--- @param ignoreCase boolean Optional - Ignoring the case of the scripts being compared. Suggestions: And, IsTrue, IsFalse, Not, Or, Equals, IsBiggerThan, IsSmallerThan, IsBiggerOrSmallerThan, IsAnyOrderOpen, IsOrderFilled, IsOrderOpen, IsTradeAmountEnough
--- @return number Returns a zero-based index of the first occurrence of the specified string. Output Suggestions: Equals, IsBiggerOrSmallerThan, IsSmallerThan, IsBiggerThan, Compare, Add, Sum, Sub, Mul, Mult, Div, AddPerc, AddPercentage, SubPerc, SubPercentage, Plot
--- @overload fun(value: string, searchValue: string): number
--- @overload fun(value: string, searchValue: string, optionalParameters: OptionalParametersOf_StringIndexOf): number
...
--- @param value string The main string. Suggestions: Input, Load
--- @param start number Start index, zero based. Suggestions: Input
--- @param length number The length of the substring. Suggestions: Input
