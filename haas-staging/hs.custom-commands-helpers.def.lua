...
--- @field chartIndex number | nil Default chart index. Default is 1.

--- Defines the chartIndex and interval parameter.
--- @param chartIndex number Optional - Default chart index. Default is 1. Suggestions: Input
...
--- @param interval number The interval on which the result is based. Suggestions: DefineParameter, DefineEasyIndicatorOutput
--- @return void
...
--- @param index number The array index of this value/output.
--- @param type Enum The parameter type enum. Suggestions: NumberType, ListNumberType, BooleanType, ListDynamicType, StringType, DynamicType, VoidType, EnumType
...
--- @return void
--- @overload fun(index: number, type: Enum, name: string, description: string): void
--- @overload fun(index: number, type: Enum, name: string, description: string, optionalParameters: OptionalParametersOf_DefineOutputIndex): void
