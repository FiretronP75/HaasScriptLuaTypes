...
--- @field amount number | nil Minimum absolute price change before the insurance agrees.
...
--- @param amount number Optional - Minimum absolute price change before the insurance agrees. Suggestions: Input
--- @param targetPrice number Optional - The target price of the trade. Default is the current buy or sell price. Suggestions: Input
...
--- @overload fun(amount: number, targetPrice: number): boolean
...
--- @field acceptedLoss number | nil The accepted loss in percentage. Default is 0. This also affects user-defined targetPrice.
--- @field targetPrice number | nil The target price of the trade. Can be used when placing orders beforehand in unmanaged trading.

--- Blocks enter trade when targetPrice is above the last sell order. Only works on spot and when there is no position open.
--- @param acceptedLoss number Optional - The accepted loss in percentage. Default is 0. This also affects user-defined targetPrice. Suggestions: Input
--- @param targetPrice number Optional - The target price of the trade. Can be used when placing orders beforehand in unmanaged trading. Suggestions: Input
--- @return boolean Returns true if the trade is allowed. Output Suggestions: Or, And, IsTrue, IsFalse, Not, BoolToSignal, IfElse, Switch, IfElseIf, DoBuy, DoLong, DoSell, DoShort, DoExitPosition, DoFlipPosition, DoSignal, PlaceBuyOrder, PlaceSellOrder, PlaceGoLongOrder, PlaceGoShortOrder, PlaceExitLongOrder, PlaceExitShortOrder, PlaceExitPositionOrder, PlaceCancelledOrder, InsuranceContainer
--- @overload fun(): boolean
--- @overload fun(acceptedLoss: number): boolean
...
--- @overload fun(): boolean
--- @overload fun(acceptedLoss: number): boolean
--- @overload fun(acceptedLoss: number, targetPrice: number): boolean
...
--- @overload fun(): boolean
--- @overload fun(targetPrice: number): boolean
...
--- @field percentage number | nil Minimum percentage change before the insurance agrees.
--- @field targetPrice number | nil The target price of the trade. Default is the current buy or sell price.
--- @field positionId string | nil Optional unique identifier. Required when the bot is trading multiple position at once.

--- Compares the average enter price to current price, percentage-based.
--- @param percentage number Optional - Minimum percentage change before the insurance agrees. Suggestions: Input
--- @param targetPrice number Optional - The target price of the trade. Default is the current buy or sell price. Suggestions: Input
--- @param positionId string Optional - Optional unique identifier. Required when the bot is trading multiple position at once. Suggestions: Load
--- @return boolean Returns true if the minimum price change percentage is reached. Output Suggestions: Or, And, IsTrue, IsFalse, Not, BoolToSignal, IfElse, Switch, IfElseIf, DoBuy, DoLong, DoSell, DoShort, DoExitPosition, DoFlipPosition, DoSignal, PlaceBuyOrder, PlaceSellOrder, PlaceGoLongOrder, PlaceGoShortOrder, PlaceExitLongOrder, PlaceExitShortOrder, PlaceExitPositionOrder, PlaceCancelledOrder, InsuranceContainer
--- @overload fun(): boolean
--- @overload fun(percentage: number): boolean
--- @overload fun(percentage: number, targetPrice: number): boolean
...
--- @param minutes number Number of minutes to wait after the last order. Suggestions: Input
--- @param positionId string Optional - Optional unique identifier. Required when the bot is trading multiple position at once. Suggestions: Load
--- @return boolean Returns true when the last trade is a certain number of minutes ago. Output Suggestions: Or, And, IsTrue, IsFalse, Not, BoolToSignal, IfElse, Switch, IfElseIf, DoBuy, DoLong, DoSell, DoShort, DoExitPosition, DoFlipPosition, DoSignal, PlaceBuyOrder, PlaceSellOrder, PlaceGoLongOrder, PlaceGoShortOrder, PlaceExitLongOrder, PlaceExitShortOrder, PlaceExitPositionOrder, PlaceCancelledOrder, InsuranceContainer
--- @overload fun(minutes: number): boolean
--- @overload fun(minutes: number, optionalParameters: OptionalParametersOf_StopLossCooldown): boolean
...
--- @field threshold number | nil Sideways movement threshold.
...
--- @param threshold number Optional - Sideways movement threshold. Suggestions: Input
...
--- @return boolean Returns true if the trade is allowed. Output Suggestions: Or, And, IsTrue, IsFalse, Not, BoolToSignal, IfElse, Switch, IfElseIf, DoBuy, DoLong, DoSell, DoShort, DoExitPosition, DoFlipPosition, DoSignal, PlaceBuyOrder, PlaceSellOrder, PlaceGoLongOrder, PlaceGoShortOrder, PlaceExitLongOrder, PlaceExitShortOrder, PlaceExitPositionOrder, PlaceCancelledOrder, InsuranceContainer
--- @overload fun(): boolean
--- @overload fun(threshold: number): boolean
--- @overload fun(threshold: number, interval: number): boolean
--- @overload fun(threshold: number, interval: number, fullCandles: boolean): boolean
...
--- @field threshold number | nil Trend strength threshold.
--- @field interval number | nil The ticks interval.
--- @field fullCandles boolean | nil If true, the last closed candles will be returned.
--- @field market string | nil The market of the tick. Default is the selected main market.

--- Checks the current market condition for a trend.
--- @param threshold number Optional - Trend strength threshold. Suggestions: Input
--- @param interval number Optional - The ticks interval. Suggestions: InputInterval, CurrentInterval
--- @param fullCandles boolean Optional - If true, the last closed candles will be returned.
--- @param market string Optional - The market of the tick. Default is the selected main market. Suggestions: InputAccountMarket, InputMarket, InputPriceSourceMarket, PriceMarket
--- @return boolean Returns true if the trade is allowed. Output Suggestions: Or, And, IsTrue, IsFalse, Not, BoolToSignal, IfElse, Switch, IfElseIf, DoBuy, DoLong, DoSell, DoShort, DoExitPosition, DoFlipPosition, DoSignal, PlaceBuyOrder, PlaceSellOrder, PlaceGoLongOrder, PlaceGoShortOrder, PlaceExitLongOrder, PlaceExitShortOrder, PlaceExitPositionOrder, PlaceCancelledOrder, InsuranceContainer
...
--- @overload fun(timeout: number, optionalParameters: OptionalParametersOf_WaitAfterOrder): boolean
...
--- @param timeout number Number of minutes to wait after the last trade. Suggestions: Input
--- @param positionId string Optional - Optional unique identifier. Required when the bot is trading multiple position at once. Suggestions: Load
--- @return boolean Returns true when the last trade is a certain number of minutes ago. Output Suggestions: Or, And, IsTrue, IsFalse, Not, BoolToSignal, IfElse, Switch, IfElseIf, DoBuy, DoLong, DoSell, DoShort, DoExitPosition, DoFlipPosition, DoSignal, PlaceBuyOrder, PlaceSellOrder, PlaceGoLongOrder, PlaceGoShortOrder, PlaceExitLongOrder, PlaceExitShortOrder, PlaceExitPositionOrder, PlaceCancelledOrder, InsuranceContainer
--- @overload fun(timeout: number): boolean
--- @overload fun(timeout: number, optionalParameters: OptionalParametersOf_WaitAfterTrade): boolean
