...
--- @return number Returns the version number. Output Suggestions: Equals, IsBiggerOrSmallerThan, IsSmallerThan, IsBiggerThan, Compare, Add, Sum, Sub, Mul, Mult, Div, AddPerc, AddPercentage, SubPerc, SubPercentage, Plot
...
--- @return number Returns the leverage value or -1 if request failed. Output Suggestions: Equals, IsBiggerOrSmallerThan, IsSmallerThan, IsBiggerThan, Compare, Add, Sum, Sub, Mul, Mult, Div, AddPerc, AddPercentage, SubPerc, SubPercentage, Plot
--- @overload fun(): number
--- @overload fun(market: string): number
--- @overload fun(optionalParameters: OptionalParametersOf_GetLeverage): number
...
--- @param market string Optional - The market returned by PriceMarket(), InputAccountMarket() or InputMarket() for example. Suggestions: InputAccountMarket, InputMarket, InputPriceSourceMarket, PriceMarket
--- @return number Returns the maximum leverage value or -1 if request failed. Output Suggestions: Equals, IsBiggerOrSmallerThan, IsSmallerThan, IsBiggerThan, Compare, Add, Sum, Sub, Mul, Mult, Div, AddPerc, AddPercentage, SubPerc, SubPercentage, Plot
--- @overload fun(): number
--- @overload fun(optionalParameters: OptionalParametersOf_GetMaxLeverage): number
...
--- @param interval number The interval on which the execution is based. If set on 0, the main interval is used.
...
--- @overload fun(leverage: number): boolean
--- @overload fun(leverage: number, market: string): boolean
--- @overload fun(leverage: number, optionalParameters: OptionalParametersOf_SetLeverage): boolean
